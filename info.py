...
HOW_TO_VERIFY = environ.get('HOW_TO_VERIFY', "https://t.me/How_To_Download_Fi/11")
VERIFY2_URL = environ.get('VERIFY2_URL', "ziplinker.net")
VERIFY2_API = environ.get('VERIFY2_API', "c0542d1219b48cb43bb9d6dc9f278a851bba1876")
SHORTLINK_URL = environ.get('SHORTLINK_URL', 'ziplinker.net')
SHORTLINK_API = environ.get('SHORTLINK_API', 'c0542d1219b48cb43bb9d6dc9f278a851bba1876')
IS_SHORTLINK = is_enabled((environ.get('IS_SHORTLINK', 'False')), False)
DELETE_CHANNELS = [int(dch) if id_pattern.search(dch) else dch for dch in environ.get('DELETE_CHANNELS', '0').split()]
MAX_B_TN = environ.get("MAX_B_TN", "5")
MAX_BTN = is_enabled((environ.get('MAX_BTN', "True")), True)
PORT = environ.get("PORT", "8080")
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/Av_Ke_Movies_chat')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/Av_Ke_Movies')
